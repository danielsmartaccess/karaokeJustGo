import { Song, QueueEntry, Advertisement } from '../types';
...
export const INITIAL_QUEUE: QueueEntry[] = [
  { id: 'q1', participant: 'Carlos', phone: '51982345678', song: MOCK_SONGS[5], requestedAt: fmt(30), status: 'next' },
  { id: 'q2', participant: 'Julia', phone: '51991234567', song: MOCK_SONGS[7], requestedAt: fmt(25), status: 'waiting' },
  { id: 'q3', participant: 'Marcos', phone: '51998765432', song: MOCK_SONGS[8], requestedAt: fmt(20), status: 'waiting' },
  { id: 'q4', participant: 'Fernanda', song: MOCK_SONGS[6], requestedAt: fmt(15), status: 'waiting' },
];
